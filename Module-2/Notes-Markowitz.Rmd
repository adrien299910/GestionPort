...
In this short note, we summarize the mathematical elements of the classical portfolio theory of Markowitz. Today, the benefits of diversification seem unquestionable. But it has not always been that way. The famous economist and investor J. M. Keynes wrote in 1934 in a letter to the chairman of an insurance company:

> "As time goes on I get more and more convinced that the right method > in investment
> is to put fairly large sums into enterprise which one thinks one 
> knows something
